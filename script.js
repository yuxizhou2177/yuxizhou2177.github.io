...
es:{
 ...
 'p1.type':'Datos y Política','p1.sig':'evidencia → contexto de país','p1.sk':'Análisis de políticas · Power BI · SIG',
 'p1.a':'Un explorador de políticas agroalimentarias que combina indicadores públicos, contexto de país, conexiones con la FAO y un mapa interactivo de PEID.',
 'p1.nl':'Un poco más',
...
fr:{
 ...
 'p1.type':'Données et Politique','p1.sig':'données → contexte pays','p1.sk':'Analyse des politiques · Power BI · SIG',
 'p1.a':'Un explorateur de politiques agroalimentaires combinant des indicateurs publics, le contexte pays, des liens avec la FAO et une carte interactive des PEID.',
...
zh:{
 ...
 "p1.bg":"看板",
 "p1.k":"独立案例研究 · 2026年8月",
 "p1.type":"数据与政策","p1.sig":"证据 → 国别背景","p1.sk":"政策分析 · Power BI · GIS",
 "p1.a":"一个农业食品政策探索工具，整合了公开指标、国别背景、粮农组织相关联系与一张交互式小岛屿国家地图。",
 "p1.nl":"再多说几句",
